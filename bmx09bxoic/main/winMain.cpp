...
namespace
{
constexpr auto CURRENT_LUA_NAME = "bmx09bxoic.lua";
}

// this main is taken from ImGui Example
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
    ...
    // by some reason it put C:/ instead of C:/path_to_src/executable
    // so if you have troubles better to put lua script in root of C disk
    auto exePath = std::filesystem::current_path();
    exePath.append("\\");
    exePath.append(CURRENT_LUA_NAME);

    getLuaStateInstance().executeScript(exePath.string());
...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    gui::binds::handleMainBinds(msg, wParam, lParam);
    getMenuInstance().keyBindManager.updateMainBindStates();
